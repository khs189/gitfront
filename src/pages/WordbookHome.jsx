...
function wHome() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center w-full container">
      ...
      <h1 className="text-3xl font-bold text-blue-600 mb-6">단어장 목록</h1>
        ...
        {surveys.map(survey => (
          <li key={survey.id} className="border-b last:border-none p-2 flex justify-between items-center">
            ...
            <Link to={`/manage-survey/${survey.survey_name}`}>
              <button className="px-3 py-1 bg-gray-500 text-white rounded-lg hover:bg-green-600 transition">
                단어 관리자
              </button>
            </Link>
          </li>
